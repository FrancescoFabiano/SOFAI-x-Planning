import pandas as pd
df = pd.read_csv("datasets/trainingDataset.csv")
...
def CodeT5Trainer(dataframe, source_text, target_text, model_params, output_dir="TrainedModel" ):
...
for size in ['base']:
    ...
    CodeT5Trainer(dataframe=df[:], source_text="DomainProblem", target_text="Plan", model_params=model_params, output_dir= model_params["MODEL"].replace("Salesforce/","")+"/")