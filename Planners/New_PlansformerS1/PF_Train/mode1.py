...
def CodeT5Trainer(dataframe, source_text, target_text, model_params, output_dir="mode1_model_files/" ):
...
def existing_plansformer_continual(memory_path, memory_size):
    ...
    CodeT5Trainer(dataframe=df[:memory_size], source_text="DomainProblem", target_text="Plan", model_params=model_params, output_dir="mode1_model_files/")
