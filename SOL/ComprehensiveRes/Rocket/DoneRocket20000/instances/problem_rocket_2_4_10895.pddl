...
; Solution is (:solution fuelup r0 l1,load c0 r0 l1,fly r0 l1 l2,unload c0 r0 l2,fuelup r0 l2,load c4 r0 l2,fly r0 l2 l3,unload c4 r0 l3,fuelup r0 l3,load c5 r0 l3,fly r0 l3 l1,unload c5 r0 l1,fuelup r1 l1,load c7 r1 l1,fly r1 l1 l3,unload c7 r1 l3,fuelup r1 l3,load c6 r1 l3,fly r1 l3 l2,unload c6 r1 l2,fuelup r1 l2,load c2 r1 l2,fly r1 l2 l1,unload c2 r1 l1)
