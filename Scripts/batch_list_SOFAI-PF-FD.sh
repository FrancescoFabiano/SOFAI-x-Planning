#!/usr/bin/env bash
#USAGE EXAMPLE (from the project root folder): "./Scripts/batch_list_SOFAI-PF-FD.sh Input/FilesList/NewPlansformerInputFile_0.txt 1"
#	where:
...
mkdir -p Output/SOL/
mv tmp/SOL/sol.out tmp/SOL/SOFAI-PF-FD.sol
echo "Solution of SOFAI-PF-FD batch test" | mutt -s "SOFAI-PF-FD solution" -a tmp/SOL/SOFAI-PF-FD.sol -- fabianofrancesco.cs@gmail.com
mv tmp/SOL/SOFAI-PF-FD.sol Output/SOL/SOFAI-PF-FD_"$c".sol
